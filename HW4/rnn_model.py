...
# README: https://docs.google.com/document/d/11yOS3tb-DQ1KSaT7vLmeKz6iCTmXTbUBlS2GZW4SVkI/edit?usp=sharing
...
def create_rnn_model(embedding_matrix, input_length, rnn='simple_rnn', bidirectional=False, trainable_emb=False,
                     hidden_size=256, lr=0.001, num_classes=10):
    """
...
def main(**kwargs):
    ...
    # The trainable parameter for the Embedding layer was set to false to prevent
    # updating the embeddings along with the rest of the network
    ...
    valid_sentences, valid_labels = pad_tag(get_sentences('./data.wsj/train-set.txt'), input_length)
    ...
    test_sentences, test_labels = pad_tag(get_sentences('./data.wsj/test-set.txt'), input_length)
